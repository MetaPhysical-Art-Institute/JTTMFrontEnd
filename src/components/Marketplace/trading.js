...
const Trading = () => {
  ...
  const handleBuyFromListing = (listingId, quantity, pricePerToken) => {
    ...
    const currency = "0x7980602A62D0E133A318D193Ce495A55128a130A"; // Set currency address
                ...
                listings.map((listing) => (
                  <div key={listing.id} className="flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center center-text">
                      ...
                      <label>
                        Currency:
                        <input type="text" value="0x7980602A62D0E133A318D193Ce495A55128a130A" readOnly />
                      </label>
                      <label>
                        BULL TOKENS:
